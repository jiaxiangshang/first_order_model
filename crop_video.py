...
# jiaxiang
import cv2
def crop_bbox(image, tube_bbox, image_shape=[256, 256], increase_area=0.1):
    ...
    img_new = image[top:bot, left:right]
    img_new = cv2.resize(img_new, (image_shape[0], image_shape[1]))

    scale_sq_x = w / image_shape[0]
